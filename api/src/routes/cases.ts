...
import { getCases, getCasesByCaseId, enforceCaseTransfer, updateCaseWithUserAndCreateEvent } from '../controllers/cases'
...
router.post('/:id/transfer', enforceCaseTransfer, postEventToCase)
